...
class TableTest {
    ...
    private void removeOneCardAndAssert() throws InterruptedException {
    ...
    @Test
    void removeCard_AllSlotsAreFilled() throws InterruptedException { // testing the removeCard function
        fillAllSlots();
        removeOneCardAndAssert();
    }

    @Test
    void removeCard_SomeSlotsAreFilled() throws InterruptedException { // testing the removeCard function
        fillSomeSlots();
        removeOneCardAndAssert();
    }
